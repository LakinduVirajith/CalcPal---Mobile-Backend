...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public boolean sendDiagnosisResultMail(OperationalDiagnosis result) {
        try {
            ...
            String htmlTemplate = """
                    ...
                    <head>
                        ...
                        <body style="font-family: Arial, sans-serif; color: #333;">
                            ...
                            <p><strong>Diagnosis Summary:</strong> ${diagnosisSummary} in Operational</p>
            ...
            placeholders.put("${totalScore}", String.valueOf(result.getScore()));
            placeholders.put("${diagnosisSummary}", result.getDiagnosis() != null
                    ? (result.getDiagnosis() ? "<span style='color: #e74c3c;'>At Risk</span>" : "No Risk Detected")
                    : "");
